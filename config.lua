...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 1000, bank = 30000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Server.Discord = 'https://discord.gg/qvHUtwsPEB' -- Discord invite link
