...
QBShared.Weapons = {
	...
	-- Custom
	[`weapon_beanbagshotgun`]		 = { name = 'weapon_beanbagshotgun', 	label = 'Non-Lethal Shotgun', 	weapontype = 'Shotgun', 		ammotype = 'AMMO_SHOTGUN', 	damagereason = 'Hit by a bean bag'}, -- qb-beanbagshotgun
	...
	[`weapon_glock17`] 			 	 = { name = 'weapon_glock17', 			label = 'PD Glock 17', 			weapontype = 'Pistol', 			ammotype = 'AMMO_PISTOL',	damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in'},
	...
	[`weapon_m9`] 					 = { name = 'weapon_m9', 				label = 'Beretta M9A3', 		weapontype = 'Pistol', 			ammotype = 'AMMO_PISTOL',	damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in'},
	...
	[`weapon_shiv`] 				 = { name = 'weapon_shiv', 				label = 'Shiv', 				weapontype = 'Miscellaneous', 	ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_katana`] 				 = { name = 'weapon_katana', 			label = 'Katana', 				weapontype = 'Miscellaneous', 	ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`weapon_sledgehammer`] 		 = { name = 'weapon_sledgehammer', 		label = 'Sledge Hammer', 		weapontype = 'Miscellaneous', 	ammotype = nil,				damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered'},
	...
	[`weapon_mp5`] 					 = { name = 'weapon_mp5', 		    	label = 'H&K MP5', 				weapontype = 'Submachine Gun',  ammotype = 'AMMO_SMG',		damagereason = 'Riddled / Drilled / Finished / Submachine Gunned'},
	[`weapon_colbaton`] 			 = { name = 'weapon_colbaton', 			label = 'Baton', 				weapontype = 'Miscellaneous',   ammotype = nil,	            damagereason = 'Beat'},
    	-- melee
	[`WEAPON_URBANRBFKNIFE`] 		 = { name = 'WEAPON_URBANRBFKNIFE', 	 	  	label = 'Urban Masked Butterfly Knife', 			weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_STAINEDRBFKNIFE`] 		 = { name = 'WEAPON_STAINEDRBFKNIFE', 	 		label = 'Stained Butterfly Knife', 					weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_SLAUGHTERBFKNIFE`] 	 = { name = 'WEAPON_SLAUGHTERBFKNIFE', 	 		label = 'Slaughter Butterfly Knife', 				weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_SCORCHEDBFKNIFE`] 		 = { name = 'WEAPON_SCORCHEDBFKNIFE', 	 		label = 'Scorched Butterfly Knife', 				weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_SAFARIBFKNIFE`] 		 = { name = 'WEAPON_SAFARIBFKNIFE', 	 		label = 'Safari Mesh Butterfly Knife', 				weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_KARAMBITKNIFE`] 		 = { name = 'WEAPON_KARAMBITKNIFE', 	 		label = 'Karamabit Knife', 							weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_HUNTSMANKNIFE`] 		 = { name = 'WEAPON_HUNTSMANKNIFE', 	 		label = 'Huntsman Knife', 							weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_GUTKNIFE`] 			 = { name = 'WEAPON_GUTKNIFE', 	 		  		label = 'Gut Knife', 								weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_FORESTBFKNIFE`] 		 = { name = 'WEAPON_FORESTBFKNIFE', 	 		label = 'Forest Butterfly Knife', 					weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_PERFORATOR`] 			 = { name = 'WEAPON_PERFORATOR', 	 		  	label = 'The Perforator',							weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_BLUEBFKNIFE`] 			 = { name = 'WEAPON_BLUEBFKNIFE', 	 		  	label = 'Blue Steel Butterfly Knife', 				weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_BFKNIFE`] 				 = { name = 'WEAPON_BFKNIFE', 	 		  	    label = 'Vanilla Butterfly Knife', 					weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_CHBFKNIFE`] 			 = { name = 'WEAPON_CHBFKNIFE', 	 		  	label = 'Case Hardened Butterfly Knife', 			weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_CRIMSONBFKNIFE`] 		 = { name = 'WEAPON_CRIMSONBFKNIFE', 	 		label = 'Crimson Butterfly Knife', 					weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_FADEBFKNIFE`] 			 = { name = 'WEAPON_FADEBFKNIFE', 	 		  	label = 'Fade Butterfly Knife', 					weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
	[`WEAPON_FLIPKNIFE`] 			 = { name = 'WEAPON_FLIPKNIFE', 	 		    label = 'Flip Knife', 					        	weapontype = 'Miscellaneous', ammotype = nil,				damagereason = 'Knifed / Stabbed / Eviscerated'},
